...
public class PotlatchUserDetailsManager implements UserDetailsManager {
    ...
    @Autowired
    public PotlatchUserDetailsManager(UserEntityRepository repo)
    {
    ...
    public PotlatchUserDetailsManager(Collection<UserDetails> users) {
        for (UserDetails user : users) {
            createUser(user);
        }
    }

    public PotlatchUserDetailsManager(Properties users) {
    ...
    public void createUser(UserDetails user) {
        ...
        users.put(user.getUsername().toLowerCase(), new User(user.getUsername(),user.getPassword(),user.getAuthorities()));
    ...
    public void changePassword(String oldPassword, String newPassword) {
        ...
        ((UserAttribute) user).setPassword(newPassword);
    }
